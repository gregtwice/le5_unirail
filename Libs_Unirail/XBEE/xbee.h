...
//Une trame CAN shadows sera decode et envoy� sur le Bus
...
//      Mode Ghost --> Mise � jour des flags et datas de la trame "mc_GSM_statusRun"
...
/**0->WAIT_START_DELIMITER_FRAME_XB<BR>
    ...
    <HR>Etats reception message XBEE (id 0x81 doc XBEE)<BR>
    ...
    <HR>Etats reception ACK XBEE (id 0x89 doc XBEE)<BR>
    200->RX_ACKXBEE_ID_ACK<BR>
    201->RX_ACKXBEE_STATE<BR>
    202->RX_ACKXBEE_CKS<BR>
    <HR>Etats reception ATCommand XBEE (id 0x88 doc XBEE)<BR>
